...
class TestGrammarPuLessons:
    ...
    def test_lesson_14(self):
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("ona li kama lon tenpo pimeja ni."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("tenpo pimeja ni la ona li kama."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("mi pona tawa jan, la jan li pona tawa mi."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("sina kama lon tomo mi, la mi pana e moku."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("sina lukin e telo jelo, la o moku ala e ona."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("ilo pi laso pimeja li lon tomo walo."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("suno li loje, la tenpo pona li lon."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
        ...
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("tan seme la soweli wawa pimeja li moku e ona?"),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
    ...
    def test_lesson_17(self):
        self.COMPARER.compare_phrases(
            GrammarParser.parse_text("mi wile e ni: jan Melani li kama tawa tomo mi."),
            Phrase.from_lines(
                [
                    "TEXT",
                    "└── SENTENCE",
